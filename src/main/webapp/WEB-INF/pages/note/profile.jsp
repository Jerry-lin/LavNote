...
<div class="container-narrow">
    <h1>Profile: 1098181195@qq.com</h1>

    <form method="POST" action="/profile" accept-charset="UTF-8" class="form-horizontal" role="form"><input name="_token" type="hidden" value="z3TqkUmmBWPxsuYZSlgHk75BtGJzOabv8wZMKSOX">
        <div class="form-group ">
            <label for="firstname" class="col-sm-3 control-label">First name</label>
            <div class="col-sm-9">
                <input id="firstname" class="form-control" placeholder="First name" required="required" name="firstname" type="text" value="youyujie">
            </div>
        </div>
        <div class="form-group ">
            <label for="lastname" class="col-sm-3 control-label">Last name</label>
            <div class="col-sm-9">
                <input id="lastname" class="form-control" placeholder="Last name" required="required" name="lastname" type="text" value="youyujie">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-9">
                <div>
                    To change your account password, please enter a new password here:
                </div>
            </div>
        </div>
        <div class="form-group ">
        ...
        <div class="form-group ">
            ...
            <div class="col-sm-9">
                <input id="password_confirmation" class="form-control" placeholder="Confirm" name="password_confirmation" type="password" value="">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-9">
