...
<div class="container-narrow">
    <h1>Profile: cloudron</h1>

    <form method="POST" action="/profile" accept-charset="UTF-8" class="form-horizontal" role="form"><input name="_token" type="hidden" value="PJMORKp4Qe2fdzNBkrVuXZehqQa4nFFzQjsWCufo">
        <div class="form-group ">
            <label for="firstname" class="col-sm-3 control-label">First name</label>
            <div class="col-sm-9">
                <input id="firstname" class="form-control" placeholder="First name" required="required" name="firstname" type="text" value="Cloudron">
            </div>
        </div>
        <div class="form-group ">
            <label for="lastname" class="col-sm-3 control-label">Last name</label>
            <div class="col-sm-9">
                <input id="lastname" class="form-control" placeholder="Last name" required="required" name="lastname" type="text" value="">
            </div>
        </div>
        <div class="form-group">
