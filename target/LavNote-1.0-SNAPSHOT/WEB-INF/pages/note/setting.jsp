...
<div class="container-narrow" ng-controller="SettingsController">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade" id="language">
            <form method="POST" action="/settings" accept-charset="UTF-8" id="form-language" class="form-horizontal" role="form"><input name="_token" type="hidden" value="z3TqkUmmBWPxsuYZSlgHk75BtGJzOabv8wZMKSOX">
                <div class="form-group ">
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="checkbox">
                                            <label>
                                                <input name="document_languages[]" type="checkbox" value="chi-sim"> Chinese (Simplified)
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="checkbox">
                                            <label>
                                                <input checked="checked" name="document_languages[]" type="checkbox" value="epo"> Esperanto
                                            </label>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="tab-pane fade" id="import">
            <form method="POST" action="/settings/import" accept-charset="UTF-8" id="form-import" class="form" role="form" enctype="multipart/form-data"><input name="_token" type="hidden" value="z3TqkUmmBWPxsuYZSlgHk75BtGJzOabv8wZMKSOX">
                <div class="form-group">
            ...
            <br/><br/><br/>
            <form method="POST" action="/settings/export" accept-charset="UTF-8" id="form-export" class="form" role="form"><input name="_token" type="hidden" value="z3TqkUmmBWPxsuYZSlgHk75BtGJzOabv8wZMKSOX">
                <div class="form-group">
                    <label class="control-label">
