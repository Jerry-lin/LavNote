    ...
    var settings = {},
        ...
        data = {
            ...
            getAfterA: function(setting, node, array) {
                for (var i = 0,
                         j = _init.afterA.length; i < j; i++) {
                    _init.afterA[i].apply(this, arguments)
                }
            },
            getBeforeA: function(setting, node, array) {
                for (var i = 0,
                         j = _init.beforeA.length; i < j; i++) {
                    _init.beforeA[i].apply(this, arguments)
                }
            },
            getInnerAfterA: function(setting, node, array) {
                for (var i = 0,
                         j = _init.innerAfterA.length; i < j; i++) {
                    _init.innerAfterA[i].apply(this, arguments)
                }
            },
            getInnerBeforeA: function(setting, node, array) {
                for (var i = 0,
                         j = _init.innerBeforeA.length; i < j; i++) {
            ...
            initCache: function(setting) {
                for (var i = 0,
                         j = _init.caches.length; i < j; i++) {
                    _init.caches[i].apply(this, arguments)
                }
            },
            initNode: function(setting, level, node, parentNode, preNode, nextNode) {
                for (var i = 0,
                         j = _init.nodes.length; i < j; i++) {
                    _init.nodes[i].apply(this, arguments)
                }
            },
            initRoot: function(setting) {
                for (var i = 0,
                         j = _init.roots.length; i < j; i++) {
            ...
            isSelectedNode: function(setting, node) {
                var root = data.getRoot(setting);
                for (var i = 0,
                         j = root.curSelectedList.length; i < j; i++) {
            ...
            setZTreeTools: function(setting, zTreeTools) {
                for (var i = 0,
                         j = _init.zTreeTools.length; i < j; i++) {
        ...
        event = {
            bindEvent: function(setting) {
                for (var i = 0,
                         j = _init.bind.length; i < j; i++) {
                    _init.bind[i].apply(this, arguments)
                }
            },
            unbindEvent: function(setting) {
                for (var i = 0,
                         j = _init.unbind.length; i < j; i++) {
        ...
        tools = {
            ...
            getMDom: function(setting, curDom, targetExpr) {
                ...
                while (curDom && curDom.id !== setting.treeId) {
                    for (var i = 0,
                             l = targetExpr.length; curDom.tagName && i < l; i++) {
        ...
        view = {
                ...
                if (parentNode) {
                    ...
                    if (!isSilent) {
                        if (parentNode.Subs.length == 1) {
                            view.expandCollapseParentNode(setting, parentNode, true, true,
                                function() {
            ...
            removeNode: function(setting, node) {
                ...
                data.removeSelectedNode(setting, node);
                for (var i = 0,
                         l = parentNode[childKey].length; i < l; i++) {
            ...
            var zTreeTools = {
                ...
                reAsyncChildNodes: function(parentNode, reloadType, isSilent) {
                    ...
                    if (reloadType == "refresh") {
                        ...
                        for (var i = 0,
                                 l = parentNode[childKey] ? parentNode[childKey].length: 0; i < l; i++) {
    ...
    var _consts = {
        ...
        _bindEvent = function(setting) {
            var o = setting.treeObj,
                c = consts.event;
            o.bind(c.CHECK,
                function(event, srcEvent, treeId, node) {
        ...
        _view = {
            ...
            setSonNodeCheckBox: function(setting, node, value, srcNode) {
                ...
                if (node[childKey]) {
                    for (var i = 0,
                             l = node[childKey].length; i < l && node.chkDisabled !== true; i++) {
                        var sNode = node[childKey][i];
                ...
                if (o.railDraggable) {
                    bar.bind("mousedown",
                        function(e) {
                            ...
                            pageY = e.pageY;
                            $doc.bind("mousemove.slimscroll",
                                function(e) {
                                    currTop = t + e.pageY - pageY;
                                    bar.css("top", currTop);
                                    scrollContent(0, bar.position().top, false)
                                });
                            $doc.bind("mouseup.slimscroll",
                                function(e) {
                                    isDragg = false;
                                    hideBar();
...
LEA.cmroot = 1; (function($) {
    ...
    $.fn.contextmenu = function(option) {
            ...
            for (var i = 0; i < len; i++) {
                ...
                if (item.type == "splitLine") {
                    ...
                    if (item.type == "group" && !item.action) {
                        ...
                        var thisItem = item; (function(thisItem, tmp) {
        ...
        var me = $(option.parent).on("contextmenu", option.children,
            function(e) {
...
if (typeof jQuery === "undefined") {
    ...
    function($) {
        ...
        Carousel.prototype.to = function(pos) {
            ...
            if (this.sliding) return this.$element.one("slid",
                function() {
                    that.to(pos)
                });
        ...
        Carousel.prototype.slide = function(type, next) {
            ...
            if ($.support.transition && this.$element.hasClass("slide")) {
                ...
                $active.one($.support.transition.end,
                    function() {
