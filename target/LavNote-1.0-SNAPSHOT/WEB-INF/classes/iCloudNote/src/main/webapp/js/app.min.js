...
function logout(email) {
        ...
        location.href = UrlPrefix + "/user/logout.do?email="+email
}
...
Note.curNoteId = "",
    ...
    Note.getNotesByNotebookId = function(t) {
        ...
        if (Note.cacheByNotebookId[t][o]) {
            ...
            return Note.cacheByNotebookId[t][o][!a] = null,
                Note.cacheByNotebookId[t][o][a] = n,
                n
        }
        var n = [];
        ...
        return Note.sortNotes(n),
            Note.cacheByNotebookId[t][o] = {},
            Note.cacheByNotebookId[t][o][a] = n,
            n
    },
    ...
    Note.curHasChanged = function(t, e) {
        ...
        o.IsNew && (i.hasChanged = !0, i.title = a, LEA.topInfo && (i.Src = LEA.topInfo.src)),
        o.Title != a && (i.hasChanged = !0, i.Title = a),
        arrayEqual(o.Tags, n) || (i.hasChanged = !0, i.Tags = n.join(","));
        var r = !1;
    ...
    Note.saveInProcess = {},
    Note.savePool = {},
    Note.curChangedSaveIt = function(t, e, o) {
        var a = this;
        if (Note.curNoteId && !Note.isReadOnly) {
            ...
            return n && n.hasChanged ? (log("需要保存..."), Note.renderChangedNote(n), delete n.hasChanged, showMsg(getMsg("saving")), a.saveInProcess[n.NoteId] = !0, ajaxPost("/note/updateNoteOrContent", n,
                function(t) {
                    a.saveInProcess[n.NoteId] = !1,
                    n.IsNew && (t.IsNew = !1, Note.setNoteCache(t, !1), Pjax.changeNote(t)),
                    e && e(),
    ...
    Note.directToNote = function(t) {
        ...
        if (n += i, n >= i && o + i >= n);
            ...
            LEA.isMobile || Mobile.isMobile() || ($("#noteItemList").scrollTop(r), $("#noteItemList").slimScroll({
                scrollTo: r + "px",
                height: "100%",
                onlyScrollBar: !0
            }))
    ...
    Note.changeNote = function(t, e, o, a) {
        function n(e, o) {
            Note.contentAjax = null,
            o == Note.contentAjaxSeq && (Note.setNoteCache(e, !1), e = Note.cache[t], Note.renderNoteContent(e), i.hideContentLoading(), a && a(e))
        }
        var i = this;
        if (t) {
            Note.stopInterval();
    ...
    Note.toggleView = function(t) {
        var e;
        e = "object" == typeof t && t ? $(t.target).data("view") : t,
        e || (e = "snippet"),
            "list" == e ? $("#noteItemList").addClass("list") : $("#noteItemList").removeClass("list"),
            localStorage.setItem("viewStyle", e),
            $(".view-style").removeClass("checked"),
            $(".view-" + e).addClass("checked")
    },
    Note.setNotesSorter = function(t) {
        var e = $(t.currentTarget).data("sorter");
        e || (e = "dateUpdatedDESC"),
            localStorage.setItem("sorterType", e),
            Note.checkSorter(e),
            Note._isTag || Note._isSearch || Note._isShare ? Note.renderNotesAndFirstOneContent(Note._everNotes, !1) : Notebook.changeNotebook(Notebook.curNotebookId)
    };
...
Note.checkSorter = function(t) {
    ...
    Note.renderNotesC = 0,
    Note.renderNotes = function(t, e, o, a) {
    ...
    Note._renderNotes = function(t, e, o, a) {
        for (var n = t.length,
            ...
            e || 0 != i || (s += " item-active");
            var c;
            c = r.ImgSrc ? tt(Note.itemTpl, s, i, r.NoteId, r.ImgSrc, r.Title, Notebook.getNotebookTitle(r.NotebookId), goNowToDatetime(r.UpdatedTime), r.Desc) : tt(Note.itemTplNoImg, s, i, r.NoteId, r.Title, Notebook.getNotebookTitle(r.NotebookId), goNowToDatetime(r.UpdatedTime), r.Desc),
                c = $(c),
                r.IsBlog ? c.addClass("item-b") : c.removeClass("item-b"),
    ...
    Note.newNote = function(t, e, o, a) {
        t || (t = $("#curNotebookForNewNote").attr("notebookId")),
            switchEditor(a),
            Note.hideEditorMask(),
            Note.hideReadOnly(),
            Note.stopInterval(),
        ...
        LEA.topInfo && LEA.topInfo.title && (n.Title = LEA.topInfo.title),
            Note.addNoteCache(n),
            Note.clearCacheByNotebookId(t),
        ...
        i = e ? tt(Note.newItemTpl, r, this.newNoteSeq(), o, n.NoteId, n.Title, c, l, "") : tt(Note.newItemTpl, r, this.newNoteSeq(), "", n.NoteId, n.Title, c, l, ""),
            i = $(i),
            s.IsBlog ? i.addClass("item-b") : i.removeClass("item-b"),
            ...
            ajaxPost("/note/setNote2Blog", {
                ...
                function(t) {
                    if (t) for (var n = 0; n < o.length; ++n) {
                        var i = o[n],
                            r = a.getTargetById(i);
                        e ? r.addClass("item-b") : r.removeClass("item-b"),
                            a.setNoteCache({
                                    NoteId: i,
                                    IsBlog: e
                                },
    ...
    Note.initContextmenu = function() {
        function t(t) {
            var e = $(this).attr("noteId"),
                o = [];
            if (Note.inBatch) o.push("shareToFriends"),
                o.push("exportPDF"),
            Notebook.curActiveNotebookIsTrash() && (o.push("shareStatus"), o.push("unset2Blog"), o.push("set2Blog"), o.push("copy"));
            else {
...
function initLeanoteIfrPlugin() {
    self != window.parent && (LEA.topInfo = {},
...
function initPage(email) {
    ...
    initLeanoteIfrPlugin(),
        LEA.topInfo ? getTopInfoSrc(function(e) {
            e ? getNoteBySrc(e,
                function(e) {
                    _initPage(e, !0)
                }) : _initPage(!1, !0)
...
function _initPage(e, t) {
    var notebooks=null;
    $.post("/note/listNoteBooks.do",{"email":User_Email},function(e)
    {
        if(e.ok) {
            notebooks = e.noteBooks;
        }

        if (e ? (curNoteId = e.NoteId, curNotebookId = e.NotebookId, noteContentJson = e) : t && (curNoteId = null), Notebook.renderNotebooks(notebooks), Share.renderShareNotebooks(sharedUserInfos, shareNotebooks), curSharedNoteNotebookId)
            ...
            curNoteId && (setTimeout(function() {
                ...
                t && (Note.toggleWriteable(), setTimeout(function() {
                        Note.toggleWriteable()
                    },
        ...
        Tag.renderTagNav(tagsJson),
            initSlimScroll(),
            LeaAce.handleEvent(),
        t && (Mobile.toEditor(), e || (Note.newNote(), Note.toggleWriteable(!0), setTimeout(function() {
                Note.toggleWriteable(!0)
            },
            100), setTimeout(function() {
                Note.toggleWriteable(!0)
...
editorMode.prototype.toggleAText = function(e) {
    ...
    editorMode.prototype.normalMode = function() {
        ...
        e += ".css";
        $("#themeLink"); - 1 != this.$themeLink.attr("href").indexOf("writting-overwrite.css") && this.$themeLink.attr("href", LEA.sPath + "/css/theme/" + e),
    ...
    $("#themeForm").on("click", "input",
        function(e) {
            var t = $(this).val(),
                ...
                n = 1;
            2 == i.length && (n = i[1]),
                $("#themeLink").attr("href", LEA.sPath + "/css/theme/" + t + ".css?id=" + n),
...
$("#leftSwitcher2").on("click",
    ...
    Mobile.isMobile() ? maxLeft(!1) : UserInfo.LeftIsMin ? minLeft(!1) : maxLeft(!1),
...
var Pjax = {
    init: function() {
        ...
        window.addEventListener("popstate",
            ...
            !1),
        history.pushState || $(window).on("hashchange",
            function() {
            ...
            if (o || i.canAndIsAce()) {
                ...
                if (0 != n.length) {
                    ...
                    try {
                        i.disableAddHistory();
                        var a = n.attr("class") || "",
                            s = -1 != a.indexOf("brush:html"); (n.attr("style") || !s && -1 != n.html().indexOf("style")) && n.html(n.text()),
        ...
        aceToPre: function(e, t) {
            ...
            if (n) {
                var r = n[0],
                    i = n[1],
                    a = r.getValue();
                isAceError(a) && (a = i.html()),
                    a = a.replace(/</g, "&lt").replace(/>/g, "&gt");
...
function reRenderTags() {
    ...
    $("#tags").children().each(function() {
        var t = $(this).attr("class"); ("label label-default" == t || "label label-info" == t) && ($(this).removeClass(t).addClass(a[e % 2]), e++)
    })
}
Tag.classes = {
    "蓝色": "label label-blue",
...
Notebook.curNotebookId = "",
                ...
                beforeRename: function(o, e, t, N) {
                    ...
                    if (e.IsNew) {
                        var a = e.getParentNode(),
                            n = a ? a.NotebookId: "";
                        b.doAddNotebook(e.NotebookId, t, n)
    ...
    Notebook.renderNotebooks = function(o) {
        var e = this; (!o || "object" != typeof o || o.length < 0) && (o = []);
        for (var t = 0,
                 N = o.length; N > t; ++t) {
            var a = o[t];
        ...
        o = [{
            ...
            Notebook.notebooks = o,
            e.tree = $.fn.zTree.init($("#notebookList"), e.getTreeSetting(), o);
        var n = $("#notebookList");
        n.hover(function() {
        ...
        isEmpty(o) || (Notebook.curNotebookId = o[0].NotebookId, e.cacheAllNotebooks(o)),
            Notebook.renderNav(),
    ...
    Notebook.getChangedNotebooks = function(o) {
        for (var e = this,
            ...
            isEmpty(n.Subs) || (b += "<ul class='dropdown-menu'>", b += e.getChangedNotebooks(n.Subs), b += "</ul>"),
                b += "</li>",
                t += b
        }
        return t
    ...
    Notebook.changeNotebook = function(o, e) {
        ...
        if (Notebook.isTrashNotebookId(o)) N = "/note/listTrashNotes",
            a = {};
        else if (Notebook.isAllNotebookId(o)) {
            if (a = {},
                    cacheNotes = Note.getNotesByNotebookId(), !isEmpty(cacheNotes)) return void(e ? e(cacheNotes) : Note.renderNotesAndFirstOneContent(cacheNotes, !0))
        } else {
    ...
    Notebook.setNotebook2Blog = function(o) {
        ...
        void 0 != t.IsBlog && (N = !t.IsBlog),
            Notebook.curNotebookId == e ? N ? $(".item").addClass("item-b") : $(".item").removeClass("item-b") : Notebook.curNotebookId == Notebook.allNotebookId && $("#noteItemList .item").each(function() {
...
Share.defaultNotebookId = "share0",
    ...
    Share.renderShareNotebooks = function(e, t) {
        ...
        var a = Share;
        if (!isEmpty(e)) { (!t || "object" != typeof t || t.length < 0) && (t = {});
    ...
    Share.initContextmenu = function(e) {
        function t(e) {
            var t = $(this).attr("noteId"),
                o = Note.getNote(t),
                r = []; (Note.inBatch || !o) && r.push("delete"),
