package cn.edu.hust.utils.email;
...
public class MailInfo {
    ...
    private String fromUserName = "not_reply@fastnote.com"; // 邮件发送者的名称，显示在他人邮件的发件人
    ...
    public MailInfo(String title, String content, List<String> receiver, List<String> ccList) {
        this.mailServerHost = PropertiesParser.getSmtpServer();
        this.userName = PropertiesParser.getSmtpUser();
        this.userPassword = PropertiesParser.getSmtpPwd();
        this.fromAddress = PropertiesParser.getFromAddress();
